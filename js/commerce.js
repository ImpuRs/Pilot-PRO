...
function _buildChalandiseOverviewInner(force){
  ...
  if(bar){
    ...
    const _universTile=_universKpi?`${_tile('🧾',formatEuro(_universKpi.avgBuyer),`CA ${escapeHtml(_universKpi.label)} / capté`,`${formatEuro(_universKpi.caUnivers)} · ${_universKpi.acheteurs}/${_universKpi.captes} acheteurs · ${formatEuro(_universKpi.avgBuyer)}/acheteur`,'#22d3ee')}`:'';
