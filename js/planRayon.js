...
function _renderPlanRayonContent(data) {
  ...
  <div id="prFamGrid" class="grid grid-cols-1 sm:grid-cols-2 gap-3">${_prBuildCards(data)}</div>
...
window._prSetFilter = function(key) {
  ...
  if (grid) grid.innerHTML = _prBuildCards(_S._prData);
